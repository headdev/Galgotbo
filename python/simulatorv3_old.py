...
if __name__ == '__main__':
    ...
    path = paths[0]
    amount_out = simulate_v2_path(path, 1000000, slot0)
    print(path, amount_out)

    amount_out = path.simulate_v2_path(1, slot0)
    print(amount_out)
    ...
    amount_outs = [path.simulate_v2_path(int(step_size * i), slot0) for i in amount_ins]
    print(amount_outs)
